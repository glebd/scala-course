...
object mnemonic {
  ...
  val wordsForNum: Map[String, Seq[String]] =
    words groupBy wordCode                        //> wordsForNum  : Map[String,Seq[String]] = Map(63972278 -> List(newscast), 292
  ...
  encode("7225247386")                            //> scala.NotImplementedError: an implementation is missing
                                                  //| 	at scala.Predef$.$qmark$qmark$qmark(Predef.scala:252)
                                                  //| 	at week6.mnemonic$$anonfun$main$1.encode$1(week6.mnemonic.scala:34)
                                                  //| 	at week6.mnemonic$$anonfun$main$1.apply$mcV$sp(week6.mnemonic.scala:36)
                                                  //| 
                                                  ...
                                                  //| 	at week6.mnemonic$.main(week6.mnemonic.scala:5)
                                                  //| 	at week6.mnemonic.main(week6.mnemonic.scala)
}